...
wp core install --path=/var/www/wordpress --allow-root --url=https://${DOMAIN_NAME} --title="CLOUD-1" --admin_user=$WORDPRESS_ADMIN_USER --admin_password=$WORDPRESS_ADMIN_PASS --admin_email=jguigli@42.fr --skip-email
